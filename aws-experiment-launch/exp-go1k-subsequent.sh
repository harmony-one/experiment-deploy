...
LAUNCH_OPT=
DASHBOARD=
#Leo: adding benchmark script here, even for subsequent run
RUN_BENCHMARK=run_benchmark-attack-cross60.sh 
...
#Leo: commenting out deploying of soldiers and skip client and skip leader code.
...
#Leo Commenting out TS. Must be read from profile
#pushd logs
...
# Leo: Commenting out download of validator logs (keeping this commented)
...
# Leo: Still not terminating instances
